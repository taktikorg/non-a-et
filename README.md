...
[![build status](https://img.shields.io/travis/taktikorg/non-a-et/master.svg?style=flat-square)](https://travis-ci.org/taktikorg/non-a-et)
[![npm version](https://img.shields.io/npm/v/@taktikorg/non-a-et.svg?style=flat-square)](https://www.npmjs.com/package/@taktikorg/non-a-et)
...
```sh
npm install @taktikorg/non-a-et @stripe/stripe-js
```
